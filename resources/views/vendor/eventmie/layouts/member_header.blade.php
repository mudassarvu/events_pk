...
<li>
    ...
    <ul class="dropdown-menu multi-level">
        ...
        {{-- CUSTOM --}}
        <li>
            <a class="dropdown-item" href="{{ route('myglists_index') }}"><i class="fas fa-user-circle"></i> @lang('eventmie-pro::em.manage') @lang('eventmie-pro::em.guests')</a>
        </li>

        <li>
            <a class="dropdown-item" href="{{ route('sub_organizer.index') }}"><i class="fas fa-user-circle"></i> @lang('eventmie-pro::em.manage') @lang('eventmie-pro::em.sub_organizers')</a>
        </li>

        <li>
            <a class="dropdown-item" href="{{ route('manage_reviews.index') }}"><i class="fas fa-user-circle"></i> @lang('eventmie-pro::em.manage') @lang('eventmie-pro::em.review')</a>
        </li>
        {{-- CUSTOM --}}
        ...
        <li>
            <a class="lgx-scroll" href="{{ route('pos.index') }}">
            <i class="fas fa-money-check-alt"></i> @lang('eventmie-pro::em.pos') @lang('eventmie-pro::em.bookings')</a>
        </li>
        @endif
        ...
        <li>
            ...
            <i class="fas fa-qrcode"></i> @lang('eventmie-pro::em.scan') @lang('eventmie-pro::em.ticket')</a>
        </li>
        <li>
            <a class="lgx-scroll" href="{{ route('scanner.index') }}">
            <i class="fas fa-money-check-alt"></i> @lang('eventmie-pro::em.scanner') @lang('eventmie-pro::em.bookings')</a>
        </li>
        @endif
        {{-- CUSTOM --}}

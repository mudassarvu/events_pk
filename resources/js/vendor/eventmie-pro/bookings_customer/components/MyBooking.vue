                        ...
                        <!-- CUSTOM -->
                            ...
                            <td :data-title="trans('em.actions')">
                                <div v-if="hide_ticket_download == null">
                                    <a v-if="booking.is_paid == 1 && booking.status == 1" class="lgx-btn lgx-btn-sm lgx-btn-success mb-2" :href="downloadURL(booking.id, booking.order_number)"><i class="fas fa-download"></i> {{trans('em.ticket')}}</a>
                                    <!-- CUSTOM -->
                                ...
                                <div v-if="booking.is_paid == 1 && booking.status == 1"> 
                                    <button type="button" class="lgx-btn lgx-btn-sm mb-2" @click="is_qrcode = 1;qrcode_booking_id = booking.id"><i class="fas fa-qrcode"></i> {{ trans('em.check_in')}}</button>
                                ...
                                <div v-if="booking.online_location != null && booking.is_paid == 1 && booking.status == 1"> 
                                    <button type="button" class="lgx-btn lgx-btn-sm mb-2" @click="booking_id = booking.id"><i class="fas fa-tv"></i> {{ trans('em.online') +' '+ trans('em.event') }}</button>
                                ...
                                <div v-else>
                                    <div v-if="booking.youtube_embed != null && booking.is_paid == 1 && booking.status == 1"> 
                                        <button type="button" class="lgx-btn lgx-btn-sm mb-2" @click="embed_code_modal=1;embed_code=booking.youtube_embed;online_location=booking.online_location"><i class="fab fa-youtube"></i> YouTube</button>
                                    </div>

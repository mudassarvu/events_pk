            ...
            <div class="panel panel-default lgx-panel">
                <div class="panel-heading">
                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data" class="lgx-contactform">
                        ...
                        <!-- CUSTOM -->
                        <div class="form-group">
                            <label for="youtube_embed">{{ trans('em.youtube_embed') }}</label>
                            <input type="text" class="form-control" name="youtube_embed"  v-model="youtube_embed">
                            <div v-html="youtube_embed"></div>
                        </div>    

                        <div class="form-group">
                            <label for="vimeo_embed">{{ trans('em.vimeo_embed') }}</label>
                            <input type="text" class="form-control" name="vimeo_embed"  v-model="vimeo_embed">
                            <div v-html="vimeo_embed"></div>
                        </div>    
                        <!-- CUSTOM -->
...
// CUSTOM
import MapAutocomplete from './custom/MapAutocomplete.vue';
// CUSTOM
...
export default {
    ...
    data() {
        return {
            ...
            //CUSTOM
            youtube_embed : this.event_ck.youtube_embed,
            vimeo_embed   : this.event_ck.vimeo_embed,
            //CUSTOM
